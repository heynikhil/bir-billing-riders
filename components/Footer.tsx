    ...
    <footer className="bg-gradient-to-br from-gray-900 to-indigo-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              ...
              <br />
              <span className="text-yellow-300">{businessInfo.taglineHindi}</span>
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-green-500 rounded-lg flex items-center justify-center hover:scale-110 transition-transform"
                aria-label="WhatsApp"
              >
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-gray-300">
          <p className="mb-2">
            © {currentYear} {businessInfo.name}. Trusted by 1000+ riders since{" "}
            {businessInfo.since}.
          </p>
          <p className="text-sm">
            {businessInfo.tagline} | {businessInfo.taglineHindi}
          </p>
        </div>
      </div>
    </footer>
